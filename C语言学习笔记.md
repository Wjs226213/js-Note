...
除基取余法对当前的数字不断地除2得到的余数相加就是得到的2进制数字
...
int main()
{
    signed int a = 1234123;
    unsigned int b = 222;  
    printf("u=%u",b);  // 定义了一个没有五号的数据类型输出格式需要使用u
}
```
